...
const CollectionFooter = () => (
    <View>
        <Row style={{
            width: '55%', flex: 1, justifyContent: 'center', alignSelf: 'center', paddingBottom: 20,
        }}
        >
            <View style={{
                width: 160, shadowColor: '#ffffff', shadowOpacity: 0.2, shadowRadius: 8, height: 180, backgroundColor: '#E6F5FF', flex: 1, justifyContent: 'center', alignSelf: 'center',
            }}
            >
